...
namespace Student
{
    ...
    public:
        ...
        void deletePiece(int row, int column);

        void movePieceDummy(int fromRow, int fromColumn, int toRow, int toColumn);
        void fakeInitialization(int fromRow, int fromColumn, int check,  ChessPiece **piece);
